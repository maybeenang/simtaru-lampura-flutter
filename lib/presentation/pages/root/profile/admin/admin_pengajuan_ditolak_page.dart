...
import 'package:flutter_map_simtaru/presentation/controllers/pengajuan_controller/pengajuan_ditolak_controller.dart';
...
class AdminPengajuanDitolakPage extends HookConsumerWidget {
  const AdminPengajuanDitolakPage({super.key});
    ...
    return CustomSafeArea(
      child: Scaffold(
        ...
        body: RefreshIndicator(
          onRefresh: () async {
            await ref.read(pengajuanDitolakControllerProvider.notifier).getPengajuan();
          },
          child: CustomScrollView(
            ...
            slivers: [
              ...
              pengajuanDitolakState.maybeWhen(
                orElse: () {
