...
class Styles {
  ...
  static dartui.Paint getPaint(feature, featurePaint, GeoJSONOptions options) {
    ...
    if (feature.type is int) {
      type =
          FeatureType.values[feature.type]; // convert geojson-vt int into enum
    } else {
      type = feature.type;
    }
    ...
    if (styleTags.containsKey('stroke-width') &&
        type == FeatureType.LineString) {
      featurePaint.strokeWidth = feature.tags['stroke-width'];
    }
    if (styleTags.containsKey('stroke-opacity') &&
        type == FeatureType.LineString) {
      featurePaint.color =
          featurePaint.color.withOpacity(feature.tags['stroke-opacity']);
    }
    if (styleTags.containsKey('fill-opacity') && type == FeatureType.Polygon) {
      featurePaint.color =
          featurePaint.color.withOpacity(feature.tags['fill-opacity']);
    }
...
class VectorLayerStyles {
  static bool includeFeature(
    ...
    if (vectorStyle.containsKey(layerString)) {
      ...
      if (layerStyle!.containsKey('types') &&
          layerStyle!['types'].containsKey(type)) {
        // types match in styling
        classOptions = funcCheck(layerStyle!['types'][type], paramsMap);
      } else if (layerStyle!.containsKey(thisClass)) {
        // normal class match in styling
  ...
  static Paint getStyle(
      style, featureInfo, layerString, type, tileZoom, scale, diffRatio) {
    var paramsMap = {
      'layer': layerString,
      'type': type,
      'zoom': tileZoom,
    ...
    if (type == 'LINESTRING' || type == 'line')
      paint.style = PaintingStyle.stroke; // are roads filled ?
    ...
    if (vectorStyle.containsKey(layerString)) {
      Map<String, dynamic>? layerClass =
          funcCheck(vectorStyle[layerString], paramsMap) ??
              funcCheck(vectorStyle['default'], paramsMap);
      List<List<dynamic>>? featureClass =
          funcCheck(vectorStyle['default'], paramsMap)?['default'];
    ...
    "default": {
      ...
      'default': [
        [
          0,
          22,
          {'color': Colors.purple, 'strokeWidth': 0.0}
        ],
      ],
    },
    ...
    "admin": {
      ...
      'default': [
        [
          0,
          22,
          {'color': Colors.deepPurple, 'strokeWidth': 0.0}
        ],
      ],
    },
    ...
    "road": {
      ...
      'default': [
        ...
        [
          16,
          22,
          {'color': Colors.orange, 'strokeWidth': 2.0}
        ],
      ],
      'service': [
        [
          12,
          22,
          {'color': Colors.blueGrey.shade600, 'strokeWidth': 0.0}
        ],
        [
          17,
          22,
          {'color': Colors.blueGrey.shade300, 'strokeWidth': 8.0}
        ],
      ],
      'street': [
        [
      ...
      'motorway': [
        ...
        [
          11,
          14,
          {'color': Colors.orange.shade200, 'strokeWidth': 3.0}
        ],
        [
          14,
          22,
          {'color': Colors.orange.shade100, 'strokeWidth': 8.0}
        ],
      ],
      'motorway_link': [
        [
      ...
      'trunk': [
        [
          0,
          11,
          {'color': Colors.orangeAccent, 'strokeWidth': 0.0}
        ],
        [
          11,
          16,
      ...
      'trunk_link': [
        ...
        [
          12,
          16,
          {'color': Colors.orange.shade100, 'strokeWidth': 3.0}
        ],
        [
          16,
          22,
      ...
      'primary': [
        [
          11,
          17,
          {'color': Colors.blueGrey.shade300, 'strokeWidth': 0.0}
        ],
        [
          17,
          22,
      ...
      'primary_link': [
        [
          11,
          17,
          {'color': Colors.blueGrey.shade400, 'strokeWidth': 0.0}
        ],
        [
          17,
          22,
      ...
      'residential': [
        ...
        [
          16,
          22,
          {'color': Colors.blueGrey.shade300, 'strokeWidth': 5.0}
        ],
        [
          17,
          22,
          {'color': Colors.blueGrey.shade300, 'strokeWidth': 7.0}
        ],
      ],
      'path': [
        [
          0,
          22,
          {'color': Colors.brown.shade400, 'strokeWidth': 2.0}
        ],
      ],
      'track': [
        [
          0,
          22,
          {'color': Colors.brown.shade300, 'strokeWidth': 2.0}
        ],
      ],
      'major_rail': [
        [
          12,
          22,
          {'color': Colors.blueGrey.shade800, 'strokeWidth': 1.0}
        ],
      ],
      'minor_rail': [
        [
      ...
      'construction': [
        [
          14,
          22,
          {'color': Colors.brown, 'strokeWidth': 0.0}
        ],
      ],
      'ferry': [
        [
          0,
          22,
          {'color': Colors.blue.shade800, 'strokeWidth': 0.0}
        ],
      ],
      'golf': [
        [
    ...
    "motorway_junction": {
      ...
      'default': [
        [
          0,
          22,
          {'color': Colors.deepPurple, 'strokeWidth': 5.0}
        ],
      ],
    },
    ...
    "landuse": {
      ...
      'residential': [
        [
          13,
          21,
          {'color': Colors.grey, 'strokeWidth': 0.0}
        ],
      ],
      'default': [
        [
          14,
          22,
          {'color': Colors.lightGreen, 'strokeWidth': 0.0}
        ],
      ],
      'airport': [
        [
      ...
      'sand': [
        [
          12,
          21,
          {'color': Colors.amber, 'strokeWidth': 0.0}
        ],
      ],
      'playground': [
        [
          14,
          22,
          {'color': Colors.green.shade400, 'strokeWidth': 0.0}
        ],
      ],
      'grass': [
        [
      ...
      'pitch': [
        [
          13,
          22,
          {'color': Colors.green, 'strokeWidth': 0.0}
        ],
      ],
      'parking': [
        [
          14,
          22,
          {'color': Colors.green.shade100, 'strokeWidth': 0.0}
        ],
      ],
      'wood': [
        [
          10,
          22,
          {'color': Colors.green.shade800, 'strokeWidth': 0.0}
        ],
      ],
      'agriculture': [
        [
          13,
          22,
          {'color': Colors.green.shade700, 'strokeWidth': 0.0}
        ],
      ],
      'school': [
        [
      ...
      'scrub': [
        [
          10,
          22,
          {'color': Colors.green.shade600, 'strokeWidth': 0.0}
        ],
      ],
      'cemetery': [
        [
    ...
    "landuse_overlay": {
      ...
      'wetland_noveg': [
        [
          11,
          22,
          {'color': Colors.blueGrey, 'strokeWidth': 0.0}
        ],
      ],
      'wetland': [
        [
          12,
          22,
          {'color': Colors.blue.shade700, 'strokeWidth': 0.0}
        ],
      ],
    },
    ...
    "water": {
      ...
      'default': [
        [
          0,
          22,
          {'color': Colors.blue.shade500, 'strokeWidth': 0.0}
        ],
      ],
    },
    ...
    "waterway": {
      ...
      'river': [
        [
          12,
          22,
          {'color': Colors.blue.shade600, 'strokeWidth': 0.0}
        ],
      ],
      'canal': [
        [
      ...
      'stream': [
        [
          14,
          22,
          {'color': Colors.blue.shade900, 'strokeWidth': 0.0}
        ],
      ],
      'stream_intermittent': [
        [
    ...
    "transit_stop": {
      ...
      'default': [
        [
          14,
          22,
          {'color': Colors.deepOrange, 'strokeWidth': 0.0}
        ],
      ],
    },
    ...
    "building": {
      ...
      'default': [
        [
          15,
          22,
          {'color': Colors.grey.shade600, 'strokeWidth': 0.0}
        ],
      ],
    },
    ...
    "structure": {
      ...
      'fence': [
        [
          15,
          22,
          {'color': Colors.brown.shade300, 'strokeWidth': 0.0}
        ],
      ],
      'hedge': [
        [
      ...
      'gate': [
        [
          16,
          22,
          {'color': Colors.brown.shade600, 'strokeWidth': 0.0}
        ],
      ],
      'land': [
        [
    ...
    "natural_label": {
      ...
      'sea': [
        [
          12,
          22,
          {'color': Colors.black, 'strokeWidth': 0.0}
        ],
      ],
      'stream': [
        [
