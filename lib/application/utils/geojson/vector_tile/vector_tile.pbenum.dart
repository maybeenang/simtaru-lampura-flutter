...
class Tile_GeomType extends $pb.ProtobufEnum {
  static const Tile_GeomType UNKNOWN = Tile_GeomType._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN');
  static const Tile_GeomType POINT = Tile_GeomType._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'POINT');
  static const Tile_GeomType LINESTRING = Tile_GeomType._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'LINESTRING');
  static const Tile_GeomType POLYGON = Tile_GeomType._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'POLYGON');
  ...
  static final $core.Map<$core.int, Tile_GeomType> _byValue =
